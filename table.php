    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Slacker</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                        <a href="index.html"><i class="fa fa-user"></i>Users</a>
                    </li>
       
                    <li>
                        <a href="table.php"><i class="fa fa-setting"></i>Update Users</a>
                        
                    </li>
                     
                     <li>
                        <a href="gallery.html"><i class="fa fa-plane"></i>Flights</a>
                    </li>
                     <li>
                        <a href="error.html"><i class="fa fa-bug "></i>Update Flights</a>
                    </li>
                    <li>
                        <a href="login.html"><i class="fa fa-sign-in "></i>Announcements</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Slacker</h1>
