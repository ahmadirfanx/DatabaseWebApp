   ...
   <ul class="nav nav-second-level collapse in">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Find bookings </h1>
                        <h1 class="page-subhead-line"> List of all registered bookings is displayed down below. In case of any error contact management at <strong>f178090@nu.edu.pk</strong></h1>
                        <br>
                        <form method="POST">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="pid" required="true">
                                        </div>
                                        <button type="submit" class="btn btn-info" name="searchBooking">Search</button>
                                    </form>
                            </div>
                            
                        </div>
                        <?php include '../controller/bookingSearchControl.php'; ?>
