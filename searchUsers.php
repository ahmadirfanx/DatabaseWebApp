    ...
    <ul class="nav nav-second-level collapse in">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Registered Users</h1>
                        <h1 class="page-subhead-line"> List of all registered customers is displayed down below. In case of any error contact management at <strong>f178090@nu.edu.pk</strong></h1>
                        <br>
                        <form method="POST">
               ...
               <div class="panel panel-info" style="width: 120%; margin-left: 30%;">
                        ...
                        <?php include '../controller/searchControl.php'; ?>
